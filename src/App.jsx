...
import { IconChevronLeft as RdcIconChevronLeft, IconClock as RdcIconClock, IconSchool as RdcIconSchool, IconBarChart as RdcIconBarChart, IconBarChartFilled as RdcIconBarChartFilled, IconList as RdcIconList, IconDownload as RdcIconDownload, IconCircleCheckFilled as RdcIconCircleCheckFilled, IconError as RdcIconError, ContentSwitch as RdcContentSwitch, ContentSwitchGroup as RdcContentSwitchGroup, InlineMessage as RdcInlineMessage } from "@rdc-npm/rdc-ui";
...
function IconCircleCheckFilled({ size = 16, color = 'currentColor' }) {
  return <RdcIconCircleCheckFilled size={size} color={color} aria-hidden="true" />;
}
        ...
        <div>
          {examples.map((ex, ei) => (
            <div key={ei}>
              ...
              {ex.descFooter && (
                <GDExDesc style={{ marginBottom: ex.descFooterItems ? 4 : 16 }}>
              ...
              {ex.descFooterItems && (
                <ul style={{ margin: "0 0 16px", paddingLeft: 20 }}>
                  {ex.descFooterItems.map((item, i) => (
                    <li key={i} style={{ fontSize: 18, color: rdcUiTheme.color.text.primary, fontFamily: FONT, lineHeight: 1.65, marginBottom: 4 }}>{item}</li>
                  ))}
                </ul>
              )}
              {ex.sensoryExample ? (
                ...
                <div style={{ width: "100%", background: rdcUiTheme.color.gray['50'], border: `1px solid ${rdcUiTheme.color.border.base}`, borderRadius: 16, padding: 40, display: "flex", alignItems: narrow ? "stretch" : "flex-start", justifyContent: "center", flexDirection: narrow ? "column" : "row", gap: 33, boxSizing: "border-box", overflow: "hidden" }}>
                  {ex.image && (ex.inlineSuccess || ex.inlineError) ? (
                    ...
                    <div style={{ display: "flex", flexDirection: narrow ? "column" : "row", alignItems: narrow ? "stretch" : "flex-start", width: "100%" }}>
                      <div style={{ flex: ex.imageFlex || 1, minWidth: 0, display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <img src={ex.image} alt="" aria-hidden="true" style={{ width: ex.imageMaxHeight ? "auto" : "100%", maxWidth: ex.imageMaxHeight ? "100%" : (ex.imageMaxWidth || "none"), maxHeight: ex.imageMaxHeight || "none", height: "auto", display: "block" }} />
                        {!ex.noImageLabels && <span style={{ marginTop: 8, fontFamily: FONT, fontSize: rdcUiTheme.typography.scale.body200.size, lineHeight: rdcUiTheme.typography.scale.body200.lineHeight, fontWeight: rdcUiTheme.typography.scale.body200.fontWeight, color: rdcUiTheme.color.text.secondary }}>{ex.imageLabel || "Live product"}</span>}
                      </div>
                      {ex.noImageLabels ? <div style={{ width: narrow ? "100%" : 48, height: narrow ? 24 : "auto", flexShrink: 0 }} /> : <div style={{ width: narrow ? "100%" : 1, height: narrow ? 1 : "auto", alignSelf: "stretch", background: rdcUiTheme.color.border.base, flexShrink: 0, margin: narrow ? "24px 0" : "0 48px" }} />}
                      <div style={{ flex: ex.imageInteractionFlex || 1, minWidth: 0, display: "flex", flexDirection: "column", alignItems: "center" }}>
                        <img src={ex.imageInteraction} alt="" aria-hidden="true" style={{ width: ex.imageMaxHeight ? "auto" : "100%", maxWidth: ex.imageMaxHeight ? "100%" : (ex.imageMaxWidth || "none"), maxHeight: ex.imageMaxHeight || "none", height: "auto", display: "block" }} />
                        {!ex.noImageLabels && <span style={{ marginTop: 8, fontFamily: FONT, fontSize: rdcUiTheme.typography.scale.body200.size, lineHeight: rdcUiTheme.typography.scale.body200.lineHeight, fontWeight: rdcUiTheme.typography.scale.body200.fontWeight, color: rdcUiTheme.color.text.secondary }}>{ex.imageInteractionLabel || "Design documentation"}</span>}
                      </div>
                    </div>
                  ...
                  ) : ex.image && ex.imageGreyBox ? (
                    <div style={{ width: "100%", background: rdcUiTheme.color.gray['50'], border: `1px solid ${rdcUiTheme.color.border.base}`, borderRadius: 16, padding: 24, boxSizing: "border-box", display: "flex", justifyContent: "center" }}>
  ...
  return (
    <div>
      ...
      {s.criteria.map((criterion, ci) => (
        <div key={ci}>
          {ci > 0 && <GDDivider style={{ margin: '80px 0' }} />}
