    ...
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          ...
          { title:"1.4.12 Text Spacing", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/text-spacing", tags:["1.4.11: Non-text contrast"], body:"Allow users to modify text spacing (like line height, paragraph spacing, letter spacing) without loss of functionality or content. This guideline is especially beneficial for users with dyslexia or other reading disabilities, as well as those who simply find it easier to read text with more space around it.", bodyNote:"Pro Tip: Ensure that your design adapts to user-defined text spacing without breaking content or functionality, keeping readability and usability intact across different languages and spacing preferences.", examples:[{ title:"Input field border", desc:"The border or outline of a form input must have sufficient contrast against its background to be clearly visible.", dont:{ caption:"Don't use a light gray border on a white background for inputs — the boundary becomes invisible to users with low contrast sensitivity." }, do:{ caption:"Do ensure input borders, icons, and UI component boundaries meet a 3:1 contrast ratio against adjacent colors." } }] },
          { title:"1.4.13 Content on Hover or Focus", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/content-on-hover-or-focus", tags:["1.4.13: Content on hover or focus"], body:"Hover-triggered or focus-triggered content like tooltips must be dismissable, hoverable, and persistent.", examples:[{ title:"Tooltip behavior", desc:"A tooltip triggered by hovering over an icon must be dismissable, remain visible when hovered, and persist until dismissed.", dont:{ caption:"Don't build tooltips that disappear immediately when the cursor moves slightly — users with motor impairments can't keep the hover steady." }, do:{ caption:"Do keep tooltip content visible as long as the cursor is within the trigger area, and allow dismissal with the Escape key." } }] }
        ]
      }]}
    ],
    quiz: QUIZZES[2]
