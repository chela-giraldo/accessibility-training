    ...
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          ...
          { title:"Ensure accessible content reflow", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/images-of-text", tags:["1.4.10: Reflow"], body:"Ensure text is actual text, not part of an image. Adding text as an image poses several accessibility issues:", bodyItems:["Legibility: Images can be resized (stretched or shrunk), leading to blurring or pixelation, making the text difficult to perceive.","Contrast: Achieving the necessary color contrast is harder to guarantee when text is embedded in an image.","Testing: Text within an image cannot be automatically tested for accessibility compliance."], bodyNote:"For optimal accessibility, always place text as actual, selectable content over an image.", examples:[{ title:"Responsive zoom layout", desc:"At 400% zoom, a single-column linear layout should emerge naturally from the responsive design.", dont:{ caption:"Don't use fixed-width layouts that force horizontal scrolling at high zoom — this creates a significant barrier for low-vision users." }, do:{ caption:"Do design mobile-first responsive layouts that reflow to a single column, ensuring all content is accessible at 400% zoom." } }] },
