    ...
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          ...
          { title:"3.2.3 Consistent Navigation", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/consistent-navigation", tags:["3.2.3: Consistent navigation"], body:"Make sure that elements with the same function are identified consistently across the UI. This guideline is vital for users with cognitive disabilities or those who rely on familiar patterns for navigation and understanding. For example, using the same patterns for UI elements:", bodyItems:["Standardizing button placement, such as always positioning \"Cancel\" on the left side.","Assigning permanent meanings to icons, such as consistently using the magnifying glass for search functions.","Utilizing identical interaction patterns, like toasts and modals, for confirming specific actions.","Maintaining uniform terminology throughout the application; for instance, avoid switching between \"Listing\" and \"Property\" across different screens."], examples:[{ title:"Navigation order across screens", desc:"If the search icon appears after the profile icon on one screen, it should appear in the same position on all screens.", dont:{ caption:"Don\'t reorder navigation items or move global controls between screens — users with cognitive disabilities build mental maps that break when layout is inconsistent." }, do:{ caption:"Do maintain the same visual and focus order for all recurring navigation elements across every screen in your product." } }] },
