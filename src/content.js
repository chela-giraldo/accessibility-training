    ...
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          ...
          { title:"1.4.13 Content on Hover or Focus", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/content-on-hover-or-focus", tags:["1.4.12: Text spacing"], body:"Ensure that increased line, word, or letter spacing doesn't break the layout or hide content.", examples:[{ title:"Text spacing override", desc:"When users apply custom text spacing via a browser extension or accessibility setting, no content should be cut off.", dont:{ caption:"Don't use fixed-height containers around text — when users increase line height, text overflows and gets clipped." }, do:{ caption:"Do use min-height or let containers grow with content so text remains visible when spacing is increased." } }] },
