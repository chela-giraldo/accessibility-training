    ...
    pages:[
      ...
      { sections:[
        { type:"guideline-detail",
          ...
          criteria:[
            { title:"2.4.1 Bypass Blocks", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/bypass-blocks", tags:["2.4.1: Bypass blocks"], body:"Provide an option for users of keyboards and assistive technology to skip repetitive content, like navigation menus, that appears on every web page. This allows them to bypass these blocks and jump directly to the main content.", examples:[{ title:"Skip navigation link", desc:"A 'Skip to main content' link at the top of each page lets keyboard users bypass repeated navigation menus.", dont:{ caption:"Don't force keyboard users to tab through a 12-item navigation menu and cookie banner on every single page before reaching the main content." }, do:{ caption:"Do add a visually hidden 'Skip to main content' link as the first focusable element so keyboard users can jump straight to the page content." } }] },
            { title:"2.4.2 Page Titled", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/page-titled", tags:["2.4.2: Page titled"], body:"Ensure all pages and screens have a title that accurately represents the content the user is viewing. This helps users identify the content and context of the page, both when they first land on it and when navigating between multiple pages or tabs.", examples:[{ title:"Unique page titles", desc:"Each page or screen must have a distinct, descriptive title so users always know where they are.", dont:{ caption:"Don't use the same generic title like 'My App' on every page — screen reader users announce the page title on load and rely on it for orientation." }, do:{ caption:"Do write descriptive, unique titles for every page using the pattern 'Page name — App name' so context is immediately clear." } }] },
            { title:"Define focus states and their order", level:"A/AA", noTitleLink: true, tags:["2.4.3: Focus order","2.4.7: Focus visible","2.4.11: Focus not obscured (minimum)"], tagLinks:[{ label:"2.4.3 Focus Order", url:"https://www.w3.org/WAI/WCAG22/Understanding/focus-order" },{ label:"2.4.7 Focus Visible", url:"https://www.w3.org/WAI/WCAG22/Understanding/focus-visible" },{ label:"2.4.11 Focus Not Obscured (Minimum)", url:"https://www.w3.org/WAI/WCAG22/Understanding/focus-not-obscured-minimum" }], body:"Since Haven design system already provides components with built-in focus states, designers primarily need to ensure two things:", bodyItems:["Document a logical and intuitive focus order for their designs.","Verify that the implementation works as expected, making sure focus order is consistent with the visual layout and focused elements remain visible and are not obscured by elements like modals or toolbars."], examples:[{ title:"Sticky header obscuring focus", desc:"A sticky navigation bar or floating toolbar can overlap the focused element, making it invisible to keyboard users.", dont:{ caption:"Don't let a sticky header cover the focused element — keyboard users lose track of where they are on the page." }, do:{ caption:"Do account for sticky elements in layout and ensure focused items always remain fully visible, never obscured by fixed UI." } }] },
            { title:"2.4.4 Link Purpose (In Context)", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-in-context", tags:["2.4.4: Link purpose (in context)"], body:"Ensure links and buttons are clearly labeled. Instead of using vague text like \"click here,\" use descriptive phrases that indicate the link's destination or function. This practice allows users to understand the purpose of the link solely from the text, enabling more efficient and confident navigation.", examples:[{ title:"Generic 'Read more' links", desc:"Multiple 'Read more' links on a page all sound identical to a screen reader user scanning links out of context.", dont:{ caption:"Don't label multiple links 'Read more' or 'Click here' — screen reader users navigating by links hear a list of meaningless identical text." }, do:{ caption:"Do write descriptive link text that identifies the destination or action: 'Read the WCAG 2.2 overview' communicates purpose without surrounding context." } }] },
