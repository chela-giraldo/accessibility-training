  ...
  { id:4, title:"WCAG principles | Understandable", emoji:"💬",
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          { title:"Present language selection upfront", level:"A/AA", tags:["3.1.1: Language of page","3.1.2: Language of parts"], tagLinks:[{ label:"3.1.1 Language of Page", url:"https://www.getstark.co/wcag-explained/understandable/readable/language-of-page/" },{ label:"3.1.2 Language of Parts", url:"https://www.w3.org/WAI/WCAG22/Understanding/language-of-parts" }], body:"If the part of your product supports multiple languages, give users the ability to select their language upfront, before they engage with any content. From there, make sure language changes within the page are clearly marked. This matters most for users who rely on screen readers and for anyone who isn\'t fluent in the content\'s primary language.", examples:[{ title:"Language selection on first use", desc:"If content is available in multiple languages, the language selection must be one of the first interactions — not buried in settings.", image:"/Images/Understandable/Present language selection upfront 1.svg", imageInteraction:"/Images/Understandable/Present language selection upfront 2.svg", imageLabel:"Consumer", imageInteractionLabel:"Client", imageMaxWidth:336, dont:{ caption:"Don\'t default to a single language without offering a selection screen — screen readers use the page language to determine pronunciation, and wrong language settings produce garbled output." }, do:{ caption:"Do present a clear language selector on first load or onboarding so users can set their preferred language before engaging with any content." } }] },
        ]
      }]},
      { sections:[{ type:"guideline-detail",
