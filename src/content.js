    ...
    pages:[
      ...
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          ...
          { title:"3.2.3 Consistent Navigation", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/consistent-navigation", tags:["3.2.3: Consistent navigation"], body:"Utilize standardized design system components for headers and footers to ensure a predictable navigational flow throughout the site. Maintain the established naming conventions, icon placement, and structural hierarchy of these global elements unless a system-wide update is implemented. Consistency in this architecture is vital across both desktop and mobile platforms to support a familiar user experience, this includes global navigation and footer navigation.", examples:[{ title:"Navigation order across screens", desc:"If the search icon appears after the profile icon on one screen, it should appear in the same position on all screens.", image:"/Images/Understandable/Consistent Navigation 1.svg", imageLabel:"Desktop footer consumer", imageFlex:1074, imageInteraction:"/Images/Understandable/Consistent Navigation 2.svg", imageInteractionLabel:"Mobile footer consumer", imageInteractionFlex:399, dont:{ caption:"Don\'t reorder navigation items or move global controls between screens, users with cognitive disabilities build mental maps that break when layout is inconsistent." }, do:{ caption:"Do maintain the same visual and focus order for all recurring navigation elements across every screen in your product." } }] },
          { title:"3.2.4 Consistent Identification", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/consistent-identification", tags:["3.2.4: Consistent identification"], body:"Make sure that elements with the same function are identified consistently across the UI. This guideline is vital for users with cognitive disabilities or those who rely on familiar patterns for navigation and understanding. For example, using the same patterns for UI elements:", bodyItems:[{ text:"Standardizing button placement, such as always positioning \"Cancel\" on the left side, unless buttons are located in a list order or in a stacked position. ", link:{ href:"https://www.figma.com/design/96TgWrQsQ031UiHEAH3ii6/%F0%9F%8F%A1-Haven-Web-Components---Design-System?m=auto&node-id=29801-33092&t=yCKiqkF274XXXVAl-1", label:"Read more about button alignment here." } },"Assigning permanent meanings to icons, such as consistently using the magnifying glass for search functions.","Utilizing identical interaction patterns, like toasts and modals, for confirming specific actions.","Maintaining uniform terminology throughout the application; for instance, avoid switching between \"Listing\" and \"Property\" across different screens."], examples:[{ title:"Submit button label consistency", desc:"Calling the same action \'Submit\', \'Send\', and \'Confirm\' on different forms confuses users who expect consistent labeling.", image:"/Images/Understandable/Consistent Identification 1.svg", imageFlex:728, imageInteraction:"/Images/Understandable/Consistent Identification 2.svg", imageInteractionFlex:1224, noImageLabels:true, dont:{ caption:"Don\'t use different labels for the same function across your product, inconsistency forces users to re-evaluate familiar patterns each time." }, do:{ caption:"Do define a vocabulary in your design system: one label per function, applied consistently everywhere, so users immediately recognize familiar controls." } }] },
          { title:"3.2.6 Consistent Help", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/consistent-help", tags:["3.2.6: Consistent help"], body:"When help mechanisms are available on a site, they should appear consistently across pages, in the same location or the same order within menus, such as always positioning help on the right bottom corner of the screen. Users should always know where to find help. That reliability is especially important for users with cognitive disabilities, those unfamiliar with the site, and screen reader users who depend on predictable page structure to navigate.", examples:[{ title:"Help link position across pages", desc:"A 'Contact support' link that appears in the footer on some pages and in the header on others is harder to find in a moment of need.", image:"/Images/Understandable/Consistent Help 1.svg", imageFlex:1464, imageInteraction:"/Images/Understandable/Consistent Help 2.svg", imageInteractionFlex:426, imageLabel:"Desktop", imageInteractionLabel:"Mobile", dont:{ caption:"Don't move help resources to different locations between pages — users who need help are already under cognitive load and shouldn't have to search for it." }, do:{ caption:"Do place help options (chat, support link, FAQ) in the same position on every page so users can find assistance predictably without additional effort." } }] }
        ]
      }]},
      { sections:[{ type:"guideline-detail",
        ...
        criteria:[
          { title:"Clearly identify errors", level:"A/AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/error-identification", tags:["3.3.1: Error identification","3.3.2: Labels or instructions","3.3.3: Error suggestion","3.3.4: Error prevention"], tagLinks:[{ label:"3.3.1 Error Identification", url:"https://www.w3.org/WAI/WCAG22/Understanding/error-identification" },{ label:"3.3.2 Labels or Instructions", url:"https://www.w3.org/WAI/WCAG22/Understanding/labels-or-instructions" },{ label:"3.3.3 Error Suggestion", url:"https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion" },{ label:"3.3.4 Error Prevention", url:"https://www.w3.org/WAI/WCAG22/Understanding/error-prevention-legal-financial-data" }], body:"In the event of an error, identification should be immediate, ideally by directing the user\'s focus to the specific issue on the page. Errors must be described using text rather than relying solely on icons or color changes. To prevent issues before they occur, every input field should be paired with clear labels and instructions that specify the required information and the correct format for entry.", bodyParagraphs:["Providing this comprehensive guidance, both before and after input, is vital for users with visual impairments, cognitive disabilities, or those unfamiliar with standard form conventions. The goal is to eliminate guesswork: users should always understand what an input field requires, exactly where a mistake has occurred, and how to resolve it after submission."], bodyNote:"Pro tip: Rather than disabling form buttons when requirements haven\'t been met, utilize the built-in error validation features of the Haven design system\'s form components.", examples:[{ title:"Form validation error", desc:"An error must be described in text, not indicated by color alone, and should suggest how to correct it.", image:"/Images/Understandable/Clearly identify errors.svg", imageMaxWidth:800, dont:{ caption:"Don\'t use a red border alone to mark an invalid field — users with color vision deficiency won\'t perceive the error, and screen reader users won\'t hear it." }, do:{ caption:"Do add an error message directly below the invalid field explaining what went wrong: \'Email address is required\' tells users exactly what to correct." } }] },
          { title:"3.3.7 Redundant Entry", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/redundant-entry", tags:["3.3.7: Redundant entry"], body:"When designing multi-step processes, avoid asking users to re-enter the same information within the same task or session. Instead, auto-fill information or provide options like checkboxes and drop-downs to reuse previously entered data. This reduces cognitive load and prevents users from making mistakes.", examples:[{ title:"Pre-filled billing address", desc:"A checkout flow that asks for shipping address and then asks for billing address should offer to copy the shipping address.", image:"/Images/Understandable/Redundant Entry.svg", imageMaxWidth:800, dont:{ caption:"Don\'t ask users to re-type their address on the billing screen after they already entered it for shipping — every extra entry is a barrier for users with motor or cognitive disabilities." }, do:{ caption:"Do offer a \'Same as shipping address\' checkbox so users can reuse information they already provided without re-entering it." } }] },
          { title:"3.3.8 Accessible Authentication (Minimum)", level:"AA", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication-minimum", tags:["3.3.8: Accessible authentication (minimum)"], body:"This guideline focuses on ensuring that logging in doesn\'t become a barrier for users with memory, attention, or comprehension difficulties. Authentication processes should not rely solely on cognitive tests like remembering or transcribing characters. Instead, provide alternatives: Logging in with google, facebook or other accounts, password manager support, biometric options like fingerprint or facial recognition, or multi-factor authentication that simply requires entering a received code.", examples:[{ title:"Login without memorization", desc:"A login screen that requires only a typed password excludes users who cannot reliably recall or type complex strings.", image:"/Images/Understandable/Accessible Authentication (Minimum).svg", imageMaxWidth:800, dont:{ caption:"Don\'t make password recall the only login method — cognitive disabilities, memory conditions, and motor impairments all make password entry unreliable." }, do:{ caption:"Do offer alternatives like passkeys, magic links, biometric login, or copy-paste-friendly OTPs so authentication doesn\'t rely on a user\'s ability to recall and type from memory." } }] }
        ]
      }]}
    ],
    quiz: QUIZZES[4]
