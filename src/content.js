    ...
    pages:[
      ...
      { sections:[
        { type:"guideline-detail",
          ...
          criteria:[
            { title:"2.4.2 Page Titled", level:"A", titleUrl:"https://www.w3.org/WAI/WCAG22/Understanding/page-titled", tags:["2.4.2: Page titled"], body:"Ensure all pages and screens have a title that accurately represents the content the user is viewing. The page title must accurately reflect the content being viewed. This is crucial for users to quickly identify the content and context when they first arrive on a page or when switching between multiple tabs or windows.", bodyNote:"Note: While the page content may have an in-menu title, this title might not be perceived by all users as the main page title. Furthermore, the menu might not be visible or available at all screen breakpoints (e.g., on mobile).", examples:[{ title:"Unique page titles", desc:"Each page or screen must have a distinct, descriptive title so users always know where they are.", image:"/Images/Operable/Page Titled 1.svg", imageLabel:"Desktop", imageInteraction:"/Images/Operable/Page Titled 2.svg", imageInteractionLabel:"Mobile", dont:{ caption:"Don't use the same generic title like 'My App' on every page — screen reader users announce the page title on load and rely on it for orientation." }, do:{ caption:"Do write descriptive, unique titles for every page using the pattern 'Page name — App name' so context is immediately clear." } }] },
